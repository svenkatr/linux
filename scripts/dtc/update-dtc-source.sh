...
LIBFDT_SOURCE="Makefile.libfdt fdt.c fdt.h fdt_overlay.c fdt_empty_tree.c fdt_ro.c fdt_rw.c fdt_strerror.c fdt_sw.c fdt_wip.c libfdt.h libfdt_env.h libfdt_internal.h"
